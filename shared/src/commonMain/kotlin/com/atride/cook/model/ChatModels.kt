...
object MockData {
    val sessions = listOf(
        Session("s1", "Kotlin协程原理探讨", "协程的挂起函数本质上是编译器层面的状态机转换...", 1753420000000L),
        Session("s2", "项目架构方案设计", "NiA风格的状态管理用UiState data class加普通函数调用就很清晰", 1753330000000L),
        Session("s3", "写一首关于秋天的诗", "秋风起兮白云飞，草木黄落兮雁南归", 1753240000000L),
        Session("s4", "DeepSeek模型对比", "DeepSeek-R1有671B参数，采用MoE架构...", 1753150000000L),
        Session("s5", "Voyager vs Navigation", "JetBrains的Navigation Compose现在已经是官方推荐方案了", 1753060000000L),
    )
